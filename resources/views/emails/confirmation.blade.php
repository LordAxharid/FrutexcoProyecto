                                                            ...
                                                            <table class="row masthead"><tbody><tr> <!-- Masthead -->
                                                                        <th class="small-12 large-12 columns first last">
                                                                            <table>
                                                                                <tr>
                                                                                    <th>
                                                                                        <h1 class="text-center">Hola, somos frutexco!</h1>
                                                                                        <center data-parsed="">
                                                                            ...
                                                                            <table class="row"><tbody><tr> <!-- main Email content -->
                                                                                        <th class="small-12 large-12 columns first last">
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <th>
                                                                                                        <b><h5>Bienvenido a frutexco!</h5></b>
                                                                                                        <p>Somos una empresa especializada en fruta fresca en el sector agroalimentario en Colombia, agricultura y calidad asegurada.<br>
																											Nuestro equipo tiene más de 12 años de experiencia en exportación de productos perecederos!<br>
																											¡¡Ahora da le click y activa tu cuenta ahora!! te esperamos!!<br></p>
                                                                                                        <br>
                                                                                                        <div class="button">
                                                                                                            <!--[if mso]>
                                                                                                            ...
                                                                                                            <![endif]-->
                                                                                                            <a href="{{ url('confirm/'.$code) }}" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:35px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Activar cuenta</a>
                                                                                                        </div>
                                                                                                    </th>
                                                                                                    <th class="expander"></th>
                                                                                                </tr>
                                                                ...
                                                                <table class="row grey"><tbody><tr>
                                                                            <th class="small-12 large-12 columns first last">
                                                                                <table>
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p class="text-center footercopy">&#xA9; Copyright 2020 frutexco. All Rights Reserved.</p>
                                                                                        </th>
                                                                                        <th class="expander"></th>
                                                                                    </tr>
                                                                                </table>
