            ...
            <table class="w320" cellspacing="0" cellpadding="0" width="500">
              <tr>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td>
                      <b>Nombre del producto</b><a></a>
                    </td>
					          <td>
                      <b>Codigo del producto</b><a></a>
                    </td>
					          <td>
                      <b>Metodo de envio</b><a></a>
                    </td>
					          <td>
                      <b>Cantidad</b><a></a>
                    </td>
                    <td>
                      <b>Precio por unidad</b><a></a>
                    </td>
					          <td>
                      <b>Total</b><a></a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="border-bottom" height="5"></td>
                    <td class="border-bottom" height="5"></td>
                    <td class="border-bottom" height="7"></td>
                    <td class="border-bottom" height="5"></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td style="padding-top:7px;" class="mobile">
					            {{ $product['product_qty'] }}
                    </td>
					@auth
							<!--CLIENTE-->
						@if(auth::user()->Cliente===1)
						<td style="padding-top:5px;">USD {{ $product['product_price'] }}$</td>
						@endif
						<!--Usuario Registrado-->
						@if(auth::user()->Cliente===0)
						<td style="padding-top:7px;">USD$</td>
						@endif
						@endauth
				...
				@auth
						<!--CLIENTE-->
                       @if(auth::user()->Cliente===1)
					<td style="padding-top:5px;" colspan="5" align="right">Total</td><td>USD {{ $productDetails['grand_total']*$product['product_qty'] }}$</td>
					@endif
						<!--Usuario Registrado-->
						@if(auth::user()->Cliente===0)
					<td style="padding-top:5px;" colspan="5" align="right"></td><td>USD$</td>
					@endif
					@endauth
				</tr>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
				  ...
				  <tr>
							...
							<tr>
								<td style="padding-top:5px;">{{ $userDetails['name'] }}</td>
							</tr>
							<tr>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td class="left" style="text-align:left;">
						          Si tienes alguna inquietud puedes contactarnos a,
                    </td>
                  </tr>
                  <tr>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E5E5E5">
                    <tr>
                      <td class="center" style="padding:25px; text-align:center;">
                        <b><a href="#">Get in touch</a></b> Frutexco 2020
                      </td>
                    </tr>
                  </table>
                </td>
