...
<head>
        <title>Frutexco Admin</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        @endif
            <form class="form-vertical" role="form" method="POST" action="{{ url('admin') }}">{{ csrf_field() }}
				 <div class="control-group normal_text"> <h3>Frutexco Admin</h3></div>
            ...
            <form id="recoverform" action="#" class="form-vertical">
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-success" id="to-login">&laquo; Atrás para iniciar sesión</a></span>
