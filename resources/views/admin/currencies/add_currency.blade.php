...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#">Monedas</a> <a href="#" class="current">Añadir monedas</a> </div>
    <h1>Monedas</h1>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('admin/add-currency') }}" name="add_currency" id="add_currency" novalidate="novalidate">{{ csrf_field() }}
              <div class="control-group">
                <label class="control-label">Código moneda</label>
                <div class="controls">
              ...
              <div class="form-actions">
                <input type="submit" value="Añadir Moneda" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
