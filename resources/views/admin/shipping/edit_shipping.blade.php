...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#">Envío</a> <a href="#" class="current">Editar envío</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('admin/edit-shipping/'.$shippingDetails->id) }}" name="edit_shipping" id="edit_shipping" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                <label class="control-label" style="font-size: 13px; width: 200px;">Gastos de envío (0-500g)&nbsp;</label>
                <div class="controls">
                  <input type="text" name="shipping_charges0_500g" id="shipping_charges0_500g"  value="{{ $shippingDetails->shipping_charges0_500g }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" style="font-size: 13px; width: 200px;">Gastos de envío (501g-1000g)&nbsp;</label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label" style="font-size: 13px; width: 200px;">Gastos de envío (1001g-2000g)&nbsp;</label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label" style="font-size: 13px; width: 200px;">Gastos de envío (2001g-5000g)&nbsp;</label>
                <div class="controls">
              ...
              <div class="form-actions">
                <input type="submit" value="Editar envío" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
