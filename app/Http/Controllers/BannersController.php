...
class BannersController extends Controller
{
    ...
    public function editBanner(Request $request, $id=null){
        if($request->isMethod('post')){
            ...
            return redirect()->back()->with('flash_message_success','El banner ha sido actualizado correctamente');
    ...
    public function deleteBanner($id = null){
        ...
        return redirect()->back()->with('flash_message_success', 'El banner ha sido eliminado con exito');
    }
