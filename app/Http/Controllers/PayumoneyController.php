...
class PayumoneyController extends Controller
{
    ...
    public function payumoneyResponse(Request $request){
        ...
        if($response['status']=="success" && $response['unmappedstatus']=="captured"){
            ...
            /* Codigo Para Enviar Correo De Orden Comienza */
            $email = $user_email;
            $messageData = [
                'email' => $email,
                'name' => $name,
            ...
            Mail::send('emails.order',$messageData,function($message) use($email){
             ...
             /* Codigo Para Enviar Correo De Orden Termina */

            // Carrito Vacio
            DB::table('cart')->where('user_email',$user_email)->delete();

            // Redirigir al usuario a la página de agradecimiento después de guardar el pedido
            ...
            // Redireccionar Usuario A Pagina De Fallo
    ...
    public function payumoneyVerify(){
        // Obtenga los últimos 5 pedidos de Payumoney
