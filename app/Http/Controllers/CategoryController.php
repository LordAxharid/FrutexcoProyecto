...
class CategoryController extends Controller
{
    public function addCategory(Request $request){
        if(Session::get('adminDetails')['categories_access']==0){
            return redirect('/admin/dashboard')->with('flash_message_error','No tienes acceso a este modulo');
        }
    	if($request->isMethod('post')){
    		...
    		$category->save();
    		return redirect()->back()->with('flash_message_success', 'La categoria ha sido agragada correctamente');
    	}
    ...
    public function deleteCategory($id = null){
        ...
        return redirect()->back()->with('flash_message_success', 'La categoria ha sido eliminada correctamente');
    }
