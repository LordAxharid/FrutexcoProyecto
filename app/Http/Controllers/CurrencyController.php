...
class CurrencyController extends Controller
{
    public function addCurrency(Request $request){
    	if($request->isMethod('post')){
    		...
    		$currency->save();
    		return redirect()->back()->with('flash_message_success','Moneda a sido actualizada correctamente!');
    	}
    ...
    public function editCurrency(Request $request,$id){
        ...
        if($request->isMethod('post')){
            ...
            return redirect()->back()->with('flash_message_success','Moneda actualizada correctamente!');
        }
    ...
    public function deleteCurrency($id){
        ...
        return redirect()->back()->with('flash_message_success','Moneda eliminada correctamente!');
    }
